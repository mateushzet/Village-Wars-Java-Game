...
public class Update {
    ...
    public void setResources(int food, int wood, int stone, int village_id){
        try {
    ...
    public void incrementResources(int food, int wood, int stone, int village_id) {
        try{
    ...
    public void setSoldiers(int pikeman, int swordsman, int axeman, int village_id) {
        try{
    ...
    public void incrementSoldiers(int pikeman, int swordsman, int axeman, int village_id){
        try{
    ...
    public void incrementBuildings(int rathaus, int warehouse, int barracks, int farm, int mine, int timbercamp, int village_id) {
        try{
    ...
    public void setBuildings(int rathaus, int warehouse, int barracks, int farm, int mine, int timbercamp, int village_id) {
        try{
